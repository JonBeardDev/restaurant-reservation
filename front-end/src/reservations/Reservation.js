...
function Reservation({ reservation }) {
  let { first_name, last_name, mobile_number, reservation_time, people } =
    reservation;
  ...
  return (
    <article className="col-sm-12 col-md-6 col-lg-4 my-2 p-2 align-self-stretch text-center">
      <div className="border border-info rounded p-4 h-100 d-flex flex-column justify-content-between reservation_card">
