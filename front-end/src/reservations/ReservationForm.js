  ...
  return (
    <main>
      ...
      <div className="res__form">
          <form className="needs-validation center py-3 border border-info rounded" onSubmit={submitHandler}>
            <div className="form-row">
              ...
              <div className="col-md-4 mb-3">
                <label htmlFor="mobile_number" className="field">Contact Number</label>
                <input
                  required
                  type="text"
                  id="mobile_number"
              ...
              <button type="submit" name="submit-btn" className="btn btn-lg btn res__button mt-0">
                Submit
              </button>
